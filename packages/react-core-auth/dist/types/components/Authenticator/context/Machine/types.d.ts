import { AuthInterpreter, NextAuthenticatorServiceFacade } from '@aws-amplify/ui';
/**
 ...
 */
export type UseMachineSelector = (context: Partial<NextAuthenticatorServiceFacade>) => NextAuthenticatorServiceFacade[ServiceFacadeKey][];
export interface UseMachine extends NextAuthenticatorServiceFacade {
}
export type Comparator = (currentMachineContext: Partial<NextAuthenticatorServiceFacade>, nextMachineContext: Partial<NextAuthenticatorServiceFacade>) => boolean;
export {};
